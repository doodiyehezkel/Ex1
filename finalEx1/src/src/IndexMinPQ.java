...
/*
 *  * ה- <tt> IndexMinPQ </ tt> בכיתה מייצגת תור עדיפות צמוד מפתחות גנריות.
 * הוא תומך רגילים <em> הוספה </ em> <em> להסיר the-המינימום </ em>
 * פעולות, יחד עם <em> להסיר </ em> <em> שינוי-the-מפתח </ em>
 * שיטות. על מנת לתת ללקוח מתייחס מפתחות על התור העדיף,
 * מספר שלם בין 0 ל maxN-1 קשור כל מקש & mdash; הלקוח
 * משתמש מספר שלם זה כדי לציין איזה מקש למחוק או לשנות.
 * הוא תומך גם שיטות מציצים מפתח המינימום,
 * בדיקות אם התור העדיף ריק, ולביקורות דרך
 * המפתחות.
 * <P>
 * יישום זה משתמש ערימה בינארית יחד עם מערך לשייך
 * מפתחות עם מספרים שלמים בטווח הנתון.
 * <Em> הוספה </ em>, <em> להסיר the-מינימום </ em>, <em> להסיר </ em>,
 * <Em> שינוי-מפתח </ em>, <em> להקטין מפתח </ em> ו- <em> להגדיל מפתח </ em>
 * פעולות לקחת זמן לוגריתמים.
 * <Em> הוא ריק </ em>, <em> גודל </ em>, <em> min-ראשי </ em>, <em> min-מפתח </ em> ו- <em> key- של </ em>
 * פעולות לקחת זמן קבוע.
 * בנייה לוקחת זמן פרופורציונאלי הקיבולת שצוינה.
 * <P>
 * לקבלת מסמכים נוספים, ראה href="http://algs4.cs.princeton.edu/24pq"> <a בסעיף 2.4 </a> של
 * <I> אלגוריתמים, 4 Edition </ i> על ידי רוברט Sedgewick וקווין ויין
 */
/**
