...
/** ה- <tt> EdgeWeightedDigraph </ tt> בכיתה מייצגת קצה משוקלל
 * Digraph של הקודקודים בשם 0 באמצעות <em> V </ em> - 1, כאשר כל
 * מכוון לקצה הוא מסוג {@link DirectedEdge} ויש לו משקל אמת מוערך.
 * הוא תומך בשני המבצעים העיקריים הבאים: להוסיף קצה מכוונת
 * אל digraph ו לחזר על כל אירוע שולי מ קודקוד נתון.
 * הוא גם מספק
 * שיטות חזרת מספר הקודקודים <em> V </ em> והמספר
 * של קצוות <em> E </ em>. קצוות מקבילים-לולאות עצמיות מותרים.
 * <P>
 * יישום זה משתמש ייצוג שכנות-רשימות, אשר
 * הוא מערך באינדקס-קודקוד של @link {תיק} אובייקטים.
 * כל הפעולות נמשכות זמן קבוע (במקרה הרע) למעט
 * Iterating על תקרית קצוות מאת קודקוד נתון, אשר לוקח
 * זמן ביחס ישר למספר של קצוות כאלה.
 */
