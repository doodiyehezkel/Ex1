...
/*
 * <I> קלט </ i>. מחלקה זו מספקת שיטות מחרוזות קריאה
 * וספר מקלט סטנדרטי, קובץ קלט, כתובות, שקעים.
 * <P>
 * האזור בשימוש הוא: language = אנגלית, ארץ = ארה"ב. זה עולה בקנה אחד
 * עם מוסכמות העיצוב עם literals נקודה צפה Java,
 * פקודות בשורת הפקודה (באמצעות {@link זוגי # parseDouble (מחרוזת)})
 * ופלט סטנדרטי.
 * <P>
 * לקבלת מסמכים נוספים, ראה
 * <a Href="http://introcs.cs.princeton.edu/31datatype"> סעיף 3.1 </a> של
 * <I> מבוא לתכנות ב- Java: גישה רב-תחומית </ i>
 * על ידי רוברט Sedgewick וקווין ויין.
 * <P>
 * כמו {סורק @link}, קריאת אסימון גם צורכת Java הקודם
 * רווחים, קריאת קו מלא צורכת
 * את delimeter סוף השורה הבאה, תוך כדי קריאת תווים צורכת
 * דבר נוסף.
 * <P>
 * שטח לבן מוגדר {@link תווים # isWhitespace (char)}. שורות חדשות
 * מורכב \ n, \ r, \ r \ n, ונקודות קוד hex Unicode 0x2028, 0x2029, 0x0085;
 * לראות <tt> <a href="http://www.docjar.com/html/api/java/util/Scanner.java.html">
 * Scanner.java </a> </ tt> (NB: Java 6u23 וגרסאות קודמות שימושים בלבד \ r, \ r, \ r \ n).
 */
/**
