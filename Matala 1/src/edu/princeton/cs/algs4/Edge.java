...
//package edu.princeton.cs.algs4;
/*
  * ה- <tt> אדג </ tt> בכיתה מייצגת קצה משוקלל בבית
  * {@link EdgeWeightedGraph}. קצה מורכב משני מספרים שלמים
  * (שמות שני קודקודים) ומשקל אמת ערך. סוג הנתונים
  * מספק שיטות גישת שתי נקודות הקצה של הקצה
  * המשקל. הסדר הטבעי עבור סוג נתונים זה הוא על ידי
  * בסדר עולה של משקל.
 */
/**
