...
/*
 *   * ä- <tt> DijkstraSP </ tt> áëéúä îééöâú ñåâ ðúåðéí ìôúøåï
  * äáòéä äîñìåì ä÷öø áéåúø îî÷åø éçéã á digraphs ÷öä îùå÷ìì
  * àéôä àú îù÷åìåú ä÷öä äí ìà ùìéìéåú.
  * <P>
  * ééùåí æä òåùä ùéîåù àìâåøéúí ãéé÷ñèøä òí òøéîä áéðàøéú.
  * äáðàé ìå÷ç æîï ôøåôåøöéåðìé <em> E </ em> éåîï <em> V </ em>,
  * ëàùø <em> V </ em> äåà îñôø ä÷åã÷åãéí å- <em> E </ em> äåà îñôø ä÷öååú.
  * ìàçø îëï, <tt> distTo () </ tt> å- <tt> hasPathTo () </ tt> ùéèåú ì÷çú
  * æîï ÷áåò åàú <tt> pathTo () </ tt> ùéèä ìå÷ç æîï ôøåôåøöéåðàìé
  * îñôø ÷öååú áðúéá ä÷öø çæø.
  * <P>
  * ì÷áìú îñîëéí ðåñôéí,
 */
